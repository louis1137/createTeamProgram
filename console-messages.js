...
const commandConsoleMessages = {
	...
	comments: {
		...
		profileNotExist: '는 존재하지 않는 프로필입니다.',
		registerNewProfile: '신규 프로필로 등록하시겠습니까?',
		...
		samePendingConstraintError: '동일인 제약은 불가능합니다.',
		...
		samePendingHiddenGroupError: '동일인 히든 그룹은 불가능합니다.',
		...
		parentWindowNotFoundReset: '부모 창 참조를 찾을 수 없습니다.',
		resetFailed: '초기화 실패:',
		...
		beforeValidation: '검증 전',
		afterValidation: '검증 후',
		confirmButton: '확인',
		...
		profileConnectedAuth: '📡 프로필 \'{profile}\' 연결됨',
		...
		profileFound: '📡 프로필 \'{profile}\' 발견 (참가자: {count}명)',
		profileFoundInitial: '📡 프로필 \'{profile}\' 발견 (초기 상태)',
		unknownCommand: '알 수 없는 명령어: <code data-cmd="도움">도움</code> 또는 <code data-cmd="help">help</code>를 입력하여 도움말을 확인하세요.',
